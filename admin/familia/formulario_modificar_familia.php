        ...
        <div class="container-fluid">
            ...
            <div class="mensaje">
                ...
                // Si hay conexión.
                    ...
                    $consulta = "SELECT COUNT(ID) FROM FAMILIA";
                    ...
                    if ($id_familia <= $fila[0]) {
                        
                        // Se obtienen los datos de una familia concreta por la ID.
                        $consulta2 = "SELECT * FROM FAMILIA WHERE ID = ".$id_familia."";
            ...
            if (!$hay_error) {
                ...
                <form id="formulario_anhadir_familia" action="./modificar_familia.php?id=<?php echo $id_familia ?>" method="post" enctype="multipart/form-data">
                    <!-- ID -->
