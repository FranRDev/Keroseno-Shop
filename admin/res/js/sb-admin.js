(function($) {
  ...
  // Impedir que la envoltura de contenido se desplace cuando la navegación lateral fija se cierna sobre...
  ...
  // Aparece el botón de desplazarse hacia arriba.
  ...
  // Desplazamiento suave usando jQuery.
